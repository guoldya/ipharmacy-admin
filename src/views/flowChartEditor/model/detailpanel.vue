    ...
    <div data-status="node-selected" class="pannel" id="node_detailpannel">
      ...
      <div class="block-container">
        <a-form>
          <a-form-item label="名称" :label-col="{ span: 5 }" :wrapper-col="{ span: 19 }">
            <a-input size="small" v-model="selectNode.label"
                     :disabled="state.labelDisabledState"/>
          </a-form-item>
        </a-form>
      </div>
      ...
      <div class="block-container" v-if="selectNode.shape == 'flow-rhombus-if'">
        <a-form>
          ...
          <a-form-item v-if="boxInitialized.inputType =='treeSelect' && selectNode.lo==3 && !selectNode.rearCondition "
                       label="包含下级"
...
<!--&lt;!&ndash;                :dropdownStyle="{ maxHeight: '300px', overflow: 'auto' }"&ndash;&gt;-->
<!--&lt;!&ndash;                :treeData=" edgeInitialized.inputEdgeSelect"&ndash;&gt;-->
<!--&lt;!&ndash;                v-model="selectEdge.assertValList"&ndash;&gt;-->
<!--&lt;!&ndash;                @change="selectEdgeTree"&ndash;&gt;-->
<!--&lt;!&ndash;              >&ndash;&gt;-->
<!--&lt;!&ndash;              </a-tree-select>&ndash;&gt;-->
<!--              <treeSelect-->
<!--                :size="'small'"-->
