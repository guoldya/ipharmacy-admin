                    ...
                    <el-table-column type="expand">
                        <template slot-scope="props">
                            <detail-list :col="4">
                                ...
                                <detail-list-item term="处方权">{{ props.row.prescRight?'有处方权':'无处方权' }}</detail-list-item>
                                <detail-list-item term="门诊抗菌药物权限">{{ setAnt(props.row.outpAntibacterial) }}</detail-list-item>
                                <detail-list-item term="住院抗菌药物权限">{{ setAnt(props.row.hospAntibacterial) }}</detail-list-item>
                            </detail-list>
                            <detail-list :col="1">
