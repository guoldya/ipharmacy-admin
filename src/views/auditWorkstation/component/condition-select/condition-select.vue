            ...
            <a-row>
                ...
                <a-col v-else-if="cd.inputType=='dataRange'" :span="4">
                    ...
                    <div class="width-100 marLeft10">
                        ...
                        <a-input style="width:18%;" class="margin-left-5" v-else value="天" disabled></a-input>
                    </div>
                </a-col>
...
<style>
.treeStyle li.ant-select-tree-treenode-disabled > span:not(.ant-select-tree-switcher),
