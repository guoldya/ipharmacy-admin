  ...
  export default {
    ...
    data() {
      return {
        ...
        columns: [
          { title: '处方', prop: 'orderNo', width: 150 },
          { title: '', prop: 'submitDoc', width: 90 },
          { title: '', prop: 'deptName', width: 80 },
          { title: '患者', prop: 'prescriptionNum',width:150 },
          { title: '', prop: 'admitNum', width: 80 },
          { title: '', prop: 'pname', width: 50 },
          { title: '', prop: 'sex', width: 60 },
          { title: '', prop: 'age', width: 60 },
        ],
        //页码初始化
        total: 2,
        current: 1,
