                        ...
                        if (res.code == '200') {
                            ...
                            for (let key in this.planruleList) {
                                ...
                                if (this.planruleList[key].columnId == 'AGE') {
                                    ...
                                    if (assertVal) {
                                        this.planruleList[key].assertVal = Number(
                                            assertVal.slice(0, $.trim(assertVal).length - 1)
                                        )
                                        spec = assertVal.slice($.trim(assertVal).length - 1, $.trim(assertVal).length)
                                    }
                                    if (assertVal2) {
                                        this.planruleList[key].assertVal2 = Number(
                                            assertVal2.slice(0, $.trim(assertVal2).length - 1)
                                        )
                                    }
                                    if (spec == '岁') {
                                ...
                                if (this.planruleList[key].logic == '1') {
                                    if (
                                        this.planruleList[key].columnId == 'AGE' ||
                                        this.planruleList[key].columnId == 'LENGTHOFSTAY'
                                    ) {
                                                ...
                                                if (res.code == '200') {
                                                    ...
                                                    for (let i in res.rows) {
                                                        if (res.rows[i].PID) {
                                                            ...
                                                            this.planruleList[key].treeData = this.recursiveNodeTree(
                                                                indexData,
                                                                'undefined'
                                                            )
                                                            pidNum += 1
                    ...
                    for (let key in listData) {
                        if (listData[key].columnId == 'AGE') {
                            ...
                            if (listData[key].logic == '1') {
                                ...
                                if (listData[key].assertVal > listData[key].assertVal2) {
                                    this.error('断言值1不能比断言值2大');
                                     this.loading = false
                                    return false
                                } else {
                                    listData[key].assertVal = '' + listData[key].assertVal + specText
