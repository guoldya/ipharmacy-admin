<template>
  <a-card>
    ...
    <a-button class="margin-top-10" type="primary" @click="add" disabled>审核通过</a-button>
    <a-button class="margin-top-10" type="primary" @click="add" disabled>审核不通过</a-button>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: '药店名称', value: 'orgName', align: 'left', width: 300 },
        { title: '区域', value: 'address', align: 'left', width: 300 },
