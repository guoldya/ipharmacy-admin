      ...
      <a-Col :span="10" class="details">
        <a-card :bodyStyle="{padding:'12px 10px'}" title="药品对码">
          ...
          <a-row class="box ">
            ...
            <a-col :span="8" > <a-input-number
              :min="1"
              size="small"
              @change="nchange"
              v-model="N"
            /></a-col>
            <a-Col :span="8"  class="td-content"> <a-input-number
              :min="1"
              size="small"
              @change="nchange"
              v-model="M"
          ...
          <a-row class="save">
            <a-Col :span="7" class="surea">
              <a-button type="primary" @click="clickSure" @loading="loading">确定</a-button>
              <a-button class="margin-left-20" @click="clickCancel">取消</a-button>
            </a-Col>
          </a-row>
        </a-card >
