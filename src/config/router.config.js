    ...
    children: [
      ...
      },
      {
        ...
        children: [
            ...
            children: [
              {
                ...
                meta: { title: '药品字典管理', keepAlive: true, hiddenHeaderContent: true, index: true }
              },
              // {
              ...
              // },
              {
                path: '/baseData/drugSpec/updateDetail/:drugCode/:drugName',
          ...
          {
            path: '/baseData/drugSpec/instructions',
            name: 'drugSpecInstructions',
            component: RouteView,
            hidden: true,
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                meta: { title: '药品组详情', hiddenHeaderContent: true, detail: true }
              }
            ]
          }
        ]
