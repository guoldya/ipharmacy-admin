...
<script>
import ganteTable from '../gante/gante-table.vue'
import ganteGc from '../gante/gante-gc.vue'
import { resize } from '../gante/resize'
import ganteSplit from '../gante/gante-split.vue'
